...
public class CodeDOM {
     ...
     * 数据连接相关
     */
    private static final String URL = "jdbc:mysql://localhost:3306/security?serverTimezone=GMT%2B8&characterEncoding=utf-8";
    ...
    public CodeDOM(String tableName) {
        ...
        basePackage_ = "com\\example\\security\\";
        ...
        basePath = System.getProperty("user.dir") + "\\security\\src\\main\\java\\" + package_;
    }
    ...
    public static void main(String[] args) {
        String[] tables = {"sys_user","sys_menu","sys_authority","sys_user_menu","sys_user_authority","sys_shortcut_menu"};
